...
namespace BinarySearchTree
{
    public class BinaryTree<T> : IEnumerable<T> where T : IComparable
    {
        ...
        private void PreOrderTraversal(Action action, BinaryTreeNode<T> node)
        {
            if (node != null)
            {
                action();
        ...
        private void PostOrderTraversal(Action action, BinaryTreeNode<T> node)
        {
            if (node != null)
            {
        ...
        private void InOrderTraversal(Action action, BinaryTreeNode<T> node)
        {
            if (node != null)
            {
...
//**************************************************************************************************** УЗЕЛ ДЕРЕВА ********
    class BinaryTreeNode<TNode> : IComparable<TNode> where TNode : IComparable
    {
